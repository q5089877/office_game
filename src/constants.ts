...
export const CARD_POOL: Card[] = [
  ...
  { id: "c17", name: "下午茶外送", description: "幫全公司訂珍奶。全體同事壓力-20，魅力+10", type: CardType.GOSSIP, mpCost: 20, stressChange: -20, chaosGain: 15, rarity: "S" },
];
...
export const DAILY_EVENTS: DailyModifier[] = [
  { id: "normal", name: "平常的一天", description: "沒什麼特別的事發生。", stressMult: 1, mpCostMod: 0, bossSpeedMult: 1 },
  { id: "friday", name: "快樂週五", description: "大家心情都很好。壓力增長-50%", stressMult: 0.5, mpCostMod: 0, bossSpeedMult: 0.8 },
  { id: "deadline", name: "地獄趕工日", description: "壓力山大！壓力增長+50%，老闆巡邏變快。", stressMult: 1.5, mpCostMod: 0, bossSpeedMult: 1.3 },
  { id: "coffee_broken", name: "咖啡機故障", description: "噩耗！所有卡片 MP 消耗 +2。", stressMult: 1.1, mpCostMod: 2, bossSpeedMult: 1 },
  { id: "boss_meeting", name: "老闆開會中", description: "老闆今天很忙。老闆巡邏變慢。", stressMult: 1, mpCostMod: 0, bossSpeedMult: 0.5 },
];
